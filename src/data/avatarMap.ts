...
const avatarByKey: Partial<Record<string, string>> = {
  ...
  observer: avatarPath('observer_review'),
  ...
  strategist: avatarPath('strategist_review'),
  ...
  pleaser: avatarPath('pleaser_review'),
  ...
  avenger: avatarPath('avenger_review'),
  ...
  avoider: avatarPath('avoider_review'),
  ...
  caregiver: avatarPath('caregiver_review'),
